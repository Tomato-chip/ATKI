...
void Vram_logic_tb___024root__trace_chg_0_sub_0(Vram_logic_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgBit(oldp+34,((0x10U > (IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__write_count))));
        ...
        bufp->chgCData(oldp+38,(vlSelf->ram_logic_tb__DOT__dut__DOT__write_count),5);
        bufp->chgCData(oldp+39,(vlSelf->ram_logic_tb__DOT__dut__DOT__read_count),5);
        bufp->chgCData(oldp+40,(vlSelf->ram_logic_tb__DOT__dut__DOT__write_address),4);
        bufp->chgCData(oldp+41,(vlSelf->ram_logic_tb__DOT__dut__DOT__read_address),4);
        bufp->chgBit(oldp+42,(vlSelf->ram_logic_tb__DOT__dut__DOT__write_buffer_sel));
        bufp->chgBit(oldp+43,(vlSelf->ram_logic_tb__DOT__dut__DOT__read_buffer_sel));
        bufp->chgBit(oldp+44,(vlSelf->ram_logic_tb__DOT__dut__DOT__read_buffer_valid));
        bufp->chgBit(oldp+45,((0x10U <= (IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__write_count))));
        bufp->chgBit(oldp+46,(vlSelf->ram_logic_tb__DOT__dut__DOT__read_in_progress));
        bufp->chgSData(oldp+47,(vlSelf->ram_logic_tb__DOT__dut__DOT__ram0_address),14);
        bufp->chgSData(oldp+48,(vlSelf->ram_logic_tb__DOT__dut__DOT__ram1_address),14);
        bufp->chgSData(oldp+49,((0x1fU & ((IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__ram0_address) 
                                          >> 4U))),9);
        bufp->chgSData(oldp+50,((0x1fU & ((IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__ram1_address) 
                                          >> 4U))),9);
    }
    bufp->chgBit(oldp+51,(vlSelf->ram_logic_tb__DOT__clk));
    bufp->chgIData(oldp+52,(vlSelf->ram_logic_tb__DOT__write_data),32);
    bufp->chgBit(oldp+53,(vlSelf->ram_logic_tb__DOT__write_valid));
    bufp->chgIData(oldp+54,(((IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__read_buffer_valid)
                              ? ((IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__read_buffer_sel)
                                 ...
                                 [(0x1fU & ((IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__ram0_address) 
                                            >> 4U))])
                              : 0U)),32);
    bufp->chgBit(oldp+55,(vlSelf->ram_logic_tb__DOT__read_ready));
    bufp->chgIData(oldp+56,(vlSelf->ram_logic_tb__DOT__test_errors),32);
    bufp->chgBit(oldp+57,(vlSelf->ram_logic_tb__DOT__dut__DOT__write_accepted));
    bufp->chgBit(oldp+58,(((IData)(vlSelf->ram_logic_tb__DOT__read_ready) 
                           & (IData)(vlSelf->ram_logic_tb__DOT__read_valid))));
    bufp->chgBit(oldp+59,(((~ (IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__write_buffer_sel)) 
                           & (IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__write_accepted))));
    bufp->chgBit(oldp+60,(((IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__write_accepted) 
                           & (IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__write_buffer_sel))));
    bufp->chgIData(oldp+61,(vlSelf->ram_logic_tb__DOT__dut__DOT__pingpong_buffer_ram0__DOT__mem
                            [(0x1fU & ((IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__ram0_address) 
                                       >> 4U))]),32);
    bufp->chgIData(oldp+62,(vlSelf->ram_logic_tb__DOT__dut__DOT__pingpong_buffer_ram1__DOT__mem
                            [(0x1fU & ((IData)(vlSelf->ram_logic_tb__DOT__dut__DOT__ram1_address) 
                                       >> 4U))]),32);
    bufp->chgIData(oldp+63,(vlSelf->ram_logic_tb__DOT__dut__DOT__pingpong_buffer_ram0__DOT__unnamedblk2__DOT__i),32);
    bufp->chgIData(oldp+64,(vlSelf->ram_logic_tb__DOT__dut__DOT__pingpong_buffer_ram1__DOT__unnamedblk2__DOT__i),32);
}
