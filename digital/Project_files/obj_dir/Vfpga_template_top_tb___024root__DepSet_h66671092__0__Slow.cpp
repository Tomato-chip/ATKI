...
VL_ATTR_COLD void Vfpga_template_top_tb___024root___eval_static__TOP(Vfpga_template_top_tb___024root* vlSelf);
...
VL_ATTR_COLD void Vfpga_template_top_tb___024root___eval_static(Vfpga_template_top_tb___024root* vlSelf) {
    ...
    // Body
    Vfpga_template_top_tb___024root___eval_static__TOP(vlSelf);
...
VL_ATTR_COLD void Vfpga_template_top_tb___024root___eval_static__TOP(Vfpga_template_top_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vfpga_template_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfpga_template_top_tb___024root___eval_static__TOP\n"); );
    // Body
    vlSelf->fpga_template_top_tb__DOT__error_count = 0U;
    vlSelf->fpga_template_top_tb__DOT__sample_number = 0U;
    vlSelf->fpga_template_top_tb__DOT__sck_edge_count = 0U;
    vlSelf->fpga_template_top_tb__DOT__ws_transition_count = 0U;
    vlSelf->fpga_template_top_tb__DOT__captured_sample_count = 0U;
...
VL_ATTR_COLD void Vfpga_template_top_tb___024root___eval_initial__TOP(Vfpga_template_top_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->fpga_template_top_tb__DOT__mic_shift_reg = 0U;
    vlSelf->fpga_template_top_tb__DOT__bit_counter = 0U;
    vlSelf->fpga_template_top_tb__DOT__mic_sd_0 = 0U;
    vlSelf->fpga_template_top_tb__DOT__sck_prev = 0U;
    vlSelf->fpga_template_top_tb__DOT__ws_prev_mic = 0U;
    vlSelf->fpga_template_top_tb__DOT__is_left_channel = 1U;
    vlSelf->fpga_template_top_tb__DOT__sample_number = 0U;
...
#endif
            VL_FATAL_MT("fpga_template_top_tb.sv", 18, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vfpga_template_top_tb___024root___dump_triggers__act(Vfpga_template_top_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge fpga_template_top_tb.clk)\n");
    }
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([true] __VdlySched.awaitingCurrentTime())\n");
    }
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([changed] fpga_template_top_tb.dut.ram_to_6led_buffer_ready_w)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vfpga_template_top_tb___024root___dump_triggers__nba(Vfpga_template_top_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge fpga_template_top_tb.clk)\n");
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([true] __VdlySched.awaitingCurrentTime())\n");
    }
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([changed] fpga_template_top_tb.dut.ram_to_6led_buffer_ready_w)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vfpga_template_top_tb___024root___ctor_var_reset(Vfpga_template_top_tb___024root* vlSelf) {
    ...
    vlSelf->fpga_template_top_tb__DOT__error_count = 0;
    vlSelf->fpga_template_top_tb__DOT__mic_shift_reg = VL_RAND_RESET_I(25);
    vlSelf->fpga_template_top_tb__DOT__bit_counter = VL_RAND_RESET_I(6);
    vlSelf->fpga_template_top_tb__DOT__sck_prev = VL_RAND_RESET_I(1);
    vlSelf->fpga_template_top_tb__DOT__ws_prev_mic = VL_RAND_RESET_I(1);
    vlSelf->fpga_template_top_tb__DOT__is_left_channel = VL_RAND_RESET_I(1);
    vlSelf->fpga_template_top_tb__DOT__sample_number = 0;
    vlSelf->fpga_template_top_tb__DOT__test_sample = VL_RAND_RESET_I(24);
    vlSelf->fpga_template_top_tb__DOT__sck_prev_mon = VL_RAND_RESET_I(1);
    vlSelf->fpga_template_top_tb__DOT__sck_edge_count = 0;
    vlSelf->fpga_template_top_tb__DOT__ws_prev = VL_RAND_RESET_I(1);
    vlSelf->fpga_template_top_tb__DOT__ws_transition_count = 0;
    vlSelf->fpga_template_top_tb__DOT__debug_led_prev = VL_RAND_RESET_I(6);
    vlSelf->fpga_template_top_tb__DOT__captured_sample_count = 0;
    vlSelf->fpga_template_top_tb__DOT__buffer_swap_count = 0;
    vlSelf->fpga_template_top_tb__DOT____Vrepeat2 = VL_RAND_RESET_I(32);
    ...
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_sampler__DOT__sck_d = VL_RAND_RESET_I(1);
    ...
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__write_address = VL_RAND_RESET_I(8);
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__read_address = VL_RAND_RESET_I(8);
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__write_count = VL_RAND_RESET_I(9);
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__read_count = VL_RAND_RESET_I(9);
    ...
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__10__Vfuncout = VL_RAND_RESET_I(14);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__10__addr = VL_RAND_RESET_I(8);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__11__Vfuncout = VL_RAND_RESET_I(14);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__11__addr = VL_RAND_RESET_I(8);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__12__Vfuncout = VL_RAND_RESET_I(14);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__12__addr = VL_RAND_RESET_I(8);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__13__Vfuncout = VL_RAND_RESET_I(14);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__13__addr = VL_RAND_RESET_I(8);
