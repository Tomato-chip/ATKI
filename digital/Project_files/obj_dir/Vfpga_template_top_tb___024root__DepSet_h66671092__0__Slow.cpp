...
VL_ATTR_COLD void Vfpga_template_top_tb___024root___ctor_var_reset(Vfpga_template_top_tb___024root* vlSelf) {
    ...
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__write_address = VL_RAND_RESET_I(5);
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__read_address = VL_RAND_RESET_I(5);
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__write_count = VL_RAND_RESET_I(6);
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__read_count = VL_RAND_RESET_I(6);
    ...
    vlSelf->fpga_template_top_tb__DOT__dut__DOT__vu__DOT__div_q = VL_RAND_RESET_I(22);
    ...
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__0__addr = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__1__Vfuncout = VL_RAND_RESET_I(14);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__1__addr = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__2__Vfuncout = VL_RAND_RESET_I(14);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__2__addr = VL_RAND_RESET_I(5);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__3__Vfuncout = VL_RAND_RESET_I(14);
    vlSelf->__Vfunc_fpga_template_top_tb__DOT__dut__DOT__u_ram__DOT__pack_address__3__addr = VL_RAND_RESET_I(5);
