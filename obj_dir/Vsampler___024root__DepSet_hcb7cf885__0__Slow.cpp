...
#endif
            VL_FATAL_MT("rtl/sampler.sv", 10, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vsampler___024root___dump_triggers__ico(Vsampler___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsampler__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsampler___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vsampler___024root___ctor_var_reset(Vsampler___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
        vlSelf->mic_data_i[__Vi0] = VL_RAND_RESET_I(16);
    }
    vlSelf->mic_valid_i = VL_RAND_RESET_I(1);
    vlSelf->buf_ready_pulse_o = VL_RAND_RESET_I(1);
    vlSelf->buf_ready_ch_o = VL_RAND_RESET_I(1);
    vlSelf->active_buf_o = VL_RAND_RESET_I(1);
    vlSelf->sampler__DOT__ch_buf_ready_pulse = VL_RAND_RESET_I(1);
    vlSelf->sampler__DOT__ch_active_buf = VL_RAND_RESET_I(1);
    vlSelf->sampler__DOT__channel_0_buffer__DOT__write_addr = VL_RAND_RESET_I(8);
    vlSelf->sampler__DOT__channel_0_buffer__DOT__buffer_full = VL_RAND_RESET_I(1);
