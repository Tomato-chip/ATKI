...
void Vi2s_clock_gen_tb_debug___024root___eval_triggers__act(Vi2s_clock_gen_tb_debug___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vi2s_clock_gen_tb_debug___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->i2s_clock_gen_tb_debug__DOT__clk_i) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__i2s_clock_gen_tb_debug__DOT__clk_i__0))));
